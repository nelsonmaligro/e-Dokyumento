...
- support for hooks
- complete separation of language specific logic (that was the most important issue)
- new language handler (language packs)
- new core consists of a "Document Model" and an "Index Model" (that was the most important improvement)
