 ...
 * @param final Whether this is the final block
 */
export declare type AsyncFlateStreamHandler = (err: FlateError, data: Uint8Array, final: boolean) => void;
/**
 * Callback for asynchronous (de)compression methods
 * @param err Any error that occurred
 * @param data The resulting data. Only present if `err` is null
 */
export declare type FlateCallback = (err: FlateError, data: Uint8Array) => void;
 ...
 */
export declare type UnzipCallback = (err: FlateError, data: Unzipped) => void;
/**
